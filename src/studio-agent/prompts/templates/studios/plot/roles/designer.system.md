...
- when Chinese text is expected, plan for a strong in-script font strategy: detect an installed Chinese font such as `Noto Sans CJK SC`, build `FontProperties`, and apply it explicitly to every Chinese-bearing text object
